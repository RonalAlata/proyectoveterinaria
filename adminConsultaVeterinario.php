...
<head>
    ...
    <title>Consultar Veterinario</title>
...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="admin.php">Administrar Usuarios</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="adminConsultaHistoria.html">Consultar Historia</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" aria-current="page" href="#">Consultar Veterinario</a>
				</li>
			</ul>
    ...
    <?php
        ...
        $v2 = $_REQUEST['Nombre'];
        //conuslta SQL
        $sql = "select * from Historia where NomVet like '".$v2."'";
        $result = mysqli_query($conn, $sql);
        //cuantos reultados hay en la busqueda
        $num_resultados = mysqli_num_rows($result);
        echo "<p>Número atenciones encontradas: ".$num_resultados."</p><br>";
    ...
    ?>
    <a href="adminConsultaVeterinario.html"><center><button class="boton">VOLVER</button></center></a>
    </section>    
</body>
</html>